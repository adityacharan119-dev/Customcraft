                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:adityacharan119@gmail.com" className="text-purple-600 hover:underline">
                        adityacharan119@gmail.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">7331180847</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        narsapur, medak, telangana, india<br />
                        pin code 502313
                      </p>
                    </div>
                  </div>
              ...
              <Card className="shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span>Sunday</span>
                      <span>11:00 AM - 6:00 PM IST</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
